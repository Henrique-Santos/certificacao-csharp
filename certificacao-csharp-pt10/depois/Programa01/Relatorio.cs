// Simbolo de compilação, a diretiva #define deve ser a primeira instrução no arquivo
...
//#endif
        ...
        void ListagemDetalhada()
        {
            ...
            {
                Console.WriteLine("{0}  {1}  {2}  {3}  {4}  {5}  {6}  {7}", venda.Data, venda.Produto, venda.Preco, venda.TipoPagamento, venda.Nome, venda.Cidade, venda.Estado, venda.Pais);
            }
            Console.WriteLine();
        }
        ...
        void ListagemResumida()
        {
            ...
            foreach (var venda in vendas)
            {
                Console.WriteLine("{0}  {1}  {2}  {3}", venda.Data, venda.Produto, venda.Preco, venda.TipoPagamento);
            }
            Console.WriteLine();
        }
    }
