    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            CodeCompileUnit unit = new CodeCompileUnit(); // é um container que irá armazenar os objetos geradores de código
            ...
            CodeMemberField nome = new CodeMemberField(typeof(string), "nome"); // Criando um campo chamado nome do tipo string
            nome.Attributes = MemberAttributes.Public; // Declarando visibilidade do campo
            ...
            // Criando os parâmetros do construtor
            ...
            codeNamespace.Types.Add(funcionario); // Adicionando a classe Funcionario ao namespace
            unit.Namespaces.Add(codeNamespace); // Adicionando o namespace a unidade de compilação

            //Tarefa 3: cria o provedor de modelo de código
            CodeDomProvider provider = CodeDomProvider.CreateProvider("CSharp"); // Irá transformar os objetos em código c#, o parametro é o nome da linguagem
